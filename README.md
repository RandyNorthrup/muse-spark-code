...
[Voice dictation](#voice-dictation) · [Limits](#limits) ·
...
| `npm run quality:gates`                   | `format:check`, `lint`, `typecheck`, `deadcode`, `cycles`, `duplication`, `test:unit`, `build`, `security:audit`: what CI runs on all three platforms                                                                                                                                                                                        |
...
(PLAN.md D32); CI runs it on Linux and Windows. Escape hatches
...
scripts/                    esbuild build; bundle-size, host-globals, notices, audit, PSScriptAnalyzer and accessibility gates; theme capture, harness screenshots, image rendering; CHANGELOG notes and VS Code versions for the workflows
