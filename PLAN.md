...
| Drops in remote windows (Claude Code #92403, audit G)                   | Checked, not affected: nothing filters `file://`; `getWorkspaceFolder` resolves `vscode-remote://` URIs.                                                                            | The first-folder rule (the context rows) keeps comparing folders, not schemes.                                                                                                                                                                                                                                                                                                                           |
...
pull request from `hardening/m24-editing`.
...
- **Scope**: the Model API's hunks, text shapes, fingerprints, unsaved-file
  ...
  modules (rules, skills, diagnostics, mentions, the first folder as the
  root); README, CHANGELOG, this file.
- **Acceptance**: a test per row, each fired against a deliberate break
