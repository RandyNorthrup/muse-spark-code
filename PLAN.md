...
| Notifications dropped without a word                         | A malformed frame vanished; `view/gap`, `turn/unqueued`, `turn/retracted`, `session/modelRouteUnserved` were unhandled.                                                                                                                                                                                    | One log line per method (unshown: info; malformed: warning). A gap re-reads the session and replaces the transcript (again if another gap arrives meanwhile). A withdrawn queued turn ends its message ("Not sent") without ending the running turn. A retract and an unserved model route are notices.                                                                                                                                                                                                                                                                                                      |
