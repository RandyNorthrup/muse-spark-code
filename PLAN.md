...
**Status 2026-09-26: implementation reconciled onto merged M47; certification pending**
(`docs/certification/m49.md`). The isolated M49 worktree is based on M47's
main merge `34002ab`, with its pre-move index tree preserved at
`refs/codex-backups/m49-pre-m47-20260926`. The first full local quality gate
...
M48 ancestry and the final ordered-tree quality gate still precede M49.
