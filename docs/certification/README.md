...
- [M63a, M63b](m63.md): the ACP agent for other editors, the Model API key in the OS credential store, and the agent's package; Emacs with agent-shell, Neovim with CodeCompanion (PLAN.md D61, D62)
